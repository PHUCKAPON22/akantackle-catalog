  ...
  if (!isAdmin) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="font-display text-lg font-semibold text-white">This account does not have admin access</h1>
        <p className="mt-1 max-w-sm text-sm text-zinc-500">
          Contact the store owner to request access, then refresh this page.
        </p>
